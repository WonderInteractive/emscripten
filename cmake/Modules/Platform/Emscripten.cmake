...
set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -sMEMORY64=2 -Wno-experimental -Wnontrivial-memcall -sUSE_PTHREADS=1 -fno-exceptions -sSUPPORT_LONGJMP=0 -DSPDLOG_NO_EXCEPTIONS -w")
set(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} -sMEMORY64=2 -Wno-experimental -sUSE_PTHREADS=1 -fno-exceptions -sSUPPORT_LONGJMP=0 -w")
